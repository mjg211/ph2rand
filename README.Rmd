...
*Design of Randomized Comparative Phase II Oncology Trials with a Binary Primary Outcome*

## Description

__ph2rand__ provides a suite of functions to assist in the design of randomized comparative phase II oncology trials with a binary primary outcome variable. Specifically, support is provided to: (a) perform a sample size calculation when using one of several published designs (Jung, 2008; Jung and Sargent, 2014; Kepner, 2010; Litwin *et al*, 2017, Shan *et al*, 2013), (b) evaluate the operating characteristics of a given design, and (c) produce informative plots.
...
We demonstrate functionality for two-stage designs, with the approach for single-stage designs being equivalent.
...
Then find the terminal points, probability mass functions, and operating characteristics of the Jung (2008) design with
